namespace CountableSystem.Module {
	partial class CountableSystemModule {
		/// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Security.CustomLogonParametersForStandardAuthentication));
            this.AdditionalExportedTypes.Add(typeof(DevExpress.ExpressApp.Security.AuthenticationStandardLogonParameters));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Security.UserRole));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.Correlative));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Utilities.CompanyBaseObject));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.FiscalCalendarCycle));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.ItemType));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Utilities.AuditableBaseObject));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.Company));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Security.CompanyUser));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.Currency));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.FiscalCalendar));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.Catalog));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.BalanceCatalog));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.BaseCatalog));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.CostCenter));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.Item));
            this.AdditionalExportedTypes.Add(typeof(CS.Model.Catalog.ItemDetail));
