...
namespace CountableSystem.Web {
    ...
    public partial class CountableSystemAspNetApplication : WebApplication {
        ...
        static CountableSystemAspNetApplication() {
        ...
        #endregion
        public CountableSystemAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void CountableSystemAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
